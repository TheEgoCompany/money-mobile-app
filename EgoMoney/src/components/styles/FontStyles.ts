...
const buttonFontStyle = StyleSheet.create({
  oblongButton: {
    ...iOSUIKit.caption2EmphasizedWhiteObject,
    fontSize: 14,
  },
});

const segmentedControlLabelFontStyle = StyleSheet.create({
  oblongButton: {
    ...iOSUIKit.caption2EmphasizedWhiteObject,
    fontSize: 14,
  },
...
const inputFontStyle = StyleSheet.create({
  inputLabel: {
...
export default {
  text: {
    ...
    oblongButton: buttonFontStyle.oblongButton,
    buttons: genericFontStyles.buttons,
    labels: genericFontStyles.medium,
    input: genericFontStyles.regular,
    inputLabel: inputFontStyle.inputLabel,
    currency: genericFontStyles.bold,
    segmentedControlLabel: segmentedControlLabelFontStyle,
  },
  generic: {
